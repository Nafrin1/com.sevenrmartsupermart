...
public class SubCategoryPage {
	...
	public String getTableContents(String subCategoryName) {
		...
		WebElement rowContent = driver.findElement(
				By.xpath("//table[@class='table table-bordered table-hover table-sm']//tbody//tr[" + index + "]"));
	...
	public boolean isSubCategoryNotPresent(String categoryName, String subCategoryName) {
		...
		String xpath = "//table[@class='table table-bordered table-hover table-sm']//tbody//tr[td[contains(text(),'"
				+ subCategoryName + "')] and td[contains(text(),'" + categoryName + "')]]";
